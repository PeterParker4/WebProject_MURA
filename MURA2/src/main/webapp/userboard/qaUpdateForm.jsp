...
<tr>
	<td colspan="2">
		<textarea rows="30" cols="100%" name="wcontent_qt">${qaArticle.wcontent_qt }</textarea>
	</td>
</tr>
...
<tr>
	<td colspan="2" align="right">
		...
		<input type="button" class="s2" value="돌아가기" onClick="document.location.href='/MURA2/userboard/qaboardList.mur?pageNum=${pageNum}'">
	</td>
</tr>
