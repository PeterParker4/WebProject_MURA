...
<form action="member.mur?cmd=signinProc" method="post" class="joinForm" name="signinForm">
      ...
      <div class="textForm">
        <input name="pass_mem" type="password" class="id" placeholder="비밀번호">
      </div>
       <div class="textForm">
      ...
      <div class="textForm">
        <div class="id">성별 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <label><input type="checkbox" name="gender_mem" value="남자">남자</label>
      ...
      <input type="submit" class="btn" value="J O I N" onClick="inputCheck()"/>
    </form>
</div>	
